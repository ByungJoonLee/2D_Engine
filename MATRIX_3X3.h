...
public:
    ...
    {
		return MATRIX_3X3(
			x[0]*A.x[0]+x[3]*A.x[1]+x[6]*A.x[2], x[1]*A.x[0]+x[4]*A.x[1]+x[7]*A.x[2], x[2]*A.x[0]+x[5]*A.x[1]+x[8]*A.x[2],
...
inline VECTOR_3D<T> operator * (const MATRIX_3X3& A, const VECTOR_3D<T>& v)
{
